...
class MyGame(arcade.Window):
   ...
   def on_mouse_press(self, x: int, y: int, button: int, modifiers: int):
       ...
       if button == arcade.MOUSE_BUTTON_LEFT: #lorseque on clique la partie gauche du mouse, on append un cerlce
           rayon = random.randint(10, 30)
           center_x = x
           center_y =y
           color = random.choice(COLORS)
       ...
       elif button == arcade.MOUSE_BUTTON_RIGHT: #lorseque on clique la partie droit du mouse, on append un rectangle
           base = random.randint(10, 30)
           heigth = random.randint(10, 30)
           center_x = x
           center_y = y
